...
summary: Monitor usage with ingestion policies and usage dashboards and alerts.
---
...
2. From the gear icon <i class="fa fa-cog"/> on the taskbar, select **Usage Portal and Subscriptions**.
